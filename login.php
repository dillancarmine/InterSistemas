                  ...
                  <div class="col-md-9 col-lg-8 mx-auto">
                    ...
                    <form action="servidor/login/logear.php" method="post" id="loginForm">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Usuario" maxlength="30">
                      ...
                      <div class="d-grid">
                        ...
                        <br>
                        <a class="small" href="registro.php">Si no tienes una cuenta ¡Regístrate Aquí!</a>
                      </div>
                    </div>
                  </form>
                </div>
