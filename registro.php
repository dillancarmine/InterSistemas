          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <form action="servidor/registro/registrar.php" method="post" id="registroForm">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" name="usuario" id="usuario" placeholder="MiUsuario" required maxlength="30">
              ...
              <br>
              <a class="d-block text-center mt-2 small" href="login.php">Ya tienes una cuenta? Inicia Sesión.</a>
