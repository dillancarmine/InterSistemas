        ...
        <div class="col-lg-6 text-center text-lg-right">
            <div class="d-inline-flex align-items-center d-block d-lg-none">
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Bienvenido</a>
                    <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                        <a href="servidor/login/logout.php" class="dropdown-item">Cerrar Sesión</a>
                    </div>
                </div>
                <a href="/carrito" class="btn px-0 ml-2">
    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="/" class="text-decoration-none">
                <img src="/public/img/logos/monitor.svg" class="w-25 h-25">;
                <span class="h1 text-capitalize text-withe bg-primary px-2">inter</span>
